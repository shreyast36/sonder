...
const PERSONA_SCREENS = [
  ...
  },
  {
    ...
    q: 'Saturday morning, the real version:',
    options: [
      { key: 'early_riser',       label: '6am alarm, gym, green smoothie, insufferable about it' },
      { key: 'slow_morning',      label: 'Noon, sheets, ignoring texts, no regrets' },
      { key: 'coffee_shop',       label: 'Coffee shop with a notebook, pretending to work' },
      { key: 'bottomless_brunch', label: 'Bottomless brunch, three hours in already' },
    ],
  },
  {
    type: 'radio',
  ...
  function handleSubmit() {
    ...
    const profile = {
      constraints: {
        ...
        saturday_morning:    persona.saturday_morning || null,
      ...
      persona_answers: {
        ...
        famous_person: persona.famous_person,
      },
    }
