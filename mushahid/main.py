...
from mushahid.routes import plan_trip, update_trip, cotraveller, chat, users, visa, export, health, persona, itineraries, journal, push, voice, shared as shared_routes, discover as discover_routes, feed as feed_routes, auth as auth_routes, destination as destination_routes
...
app.include_router(discover_routes.router, prefix="/api")
